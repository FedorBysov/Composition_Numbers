...
import com.example.composition_numbers.data.GameRepositoryImpl
...
import com.example.composition_numbers.domain.useCase.GenerateQuestionUseCase
import com.example.composition_numbers.domain.useCase.GetGameSettingsUseCase
...
class GameViewModel(
    ...
    private fun updateProgress() {
        ...
        _progressAnswers.value = String.format(
            aplication.resources.getString(R.string.progress_answers),
            countOfRightAnswers,
            gameSettings.minCountOfRightCount
        )
        _enoughCount.value = countOfRightAnswers >= gameSettings.minCountOfRightCount
